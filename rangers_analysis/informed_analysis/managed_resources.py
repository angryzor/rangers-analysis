...
from rangers_analysis.lib.segments import data_seg, rdata_seg
...
def handle_resource_ctor(instantiator_thunk, instantiator_func, ctor_thunk, ctor_func, base_ctor_func):
    class_ea = instantiator_thunk and find_class_object('ResourceTypeInfo', data_seg if rangers_analysis_config['resource_class_in_data'] else rdata_seg, 0x20 if rangers_analysis_config['large_resource_size'] else 0x18, instantiator_thunk)
